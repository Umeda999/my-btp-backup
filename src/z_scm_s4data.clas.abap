...
CLASS z_scm_s4data DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      "! <p class="shorttext synchronized">ZTRIAL_TEST_CDSType</p>
      BEGIN OF tys_ztrial_test_cdstype,
        "! <em>Key property</em> Test1
        test_1 TYPE c LENGTH 20,
        "! Test2
        test_2 TYPE c LENGTH 2,
      END OF tys_ztrial_test_cdstype,
      "! <p class="shorttext synchronized">List of ZTRIAL_TEST_CDSType</p>
      tyt_ztrial_test_cdstype TYPE STANDARD TABLE OF tys_ztrial_test_cdstype WITH DEFAULT KEY.
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_set,
        ...
        "! ZTRIAL_TEST_CDS
        "! <br/> Collection of type 'ZTRIAL_TEST_CDSType'
        ztrial_test_cds            TYPE /iwbep/if_cp_runtime_types=>ty_entity_set_name VALUE 'ZTRIAL_TEST_CDS',
    ...
    CONSTANTS:
      ...
      BEGIN OF gcs_entity_type,
        ...
        "! <p class="shorttext synchronized">Internal names for ZTRIAL_TEST_CDSType</p>
        "! See also structure type {@link ..tys_ztrial_test_cdstype}
        BEGIN OF ztrial_test_cdstype,
          "! <p class="shorttext synchronized">Navigation properties</p>
          BEGIN OF navigation,
            "! Dummy field - Structure must not be empty
            dummy TYPE int1 VALUE 0,
          END OF navigation,
        END OF ztrial_test_cdstype,
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Define ZTRIAL_TEST_CDSType</p>
    "! @raising /iwbep/cx_gateway | <p class="shorttext synchronized">Gateway Exception</p>
    METHODS def_ztrial_test_cdstype RAISING /iwbep/cx_gateway.

ENDCLASS.


CLASS z_scm_s4data IMPLEMENTATION.

  METHOD /iwbep/if_v4_mp_basic_pm~define.

    mo_model = io_model.
    mo_model->set_schema_namespace( 'cds_zui_trial' ) ##NO_TEXT.
  ...
  METHOD def_ztrial_test_cdstype.
    ...
    lo_entity_type = mo_model->create_entity_type_by_struct(
                                    iv_entity_type_name       = 'ZTRIAL_TEST_CDSTYPE'
                                    is_structure              = VALUE tys_ztrial_test_cdstype( )
                                    iv_do_gen_prim_props         = abap_true
                                    iv_do_gen_prim_prop_colls    = abap_true
                                    iv_do_add_conv_to_prim_props = abap_true ).

    lo_entity_type->set_edm_name( 'ZTRIAL_TEST_CDSType' ) ##NO_TEXT.


    lo_entity_set = lo_entity_type->create_entity_set( 'ZTRIAL_TEST_CDS' ).
    lo_entity_set->set_edm_name( 'ZTRIAL_TEST_CDS' ) ##NO_TEXT.


    lo_primitive_property = lo_entity_type->get_primitive_property( 'TEST_1' ).
    lo_primitive_property->set_edm_name( 'Test1' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
    lo_primitive_property->set_max_length( 20 ) ##NUMBER_OK.
    lo_primitive_property->set_is_key( ).

    lo_primitive_property = lo_entity_type->get_primitive_property( 'TEST_2' ).
    lo_primitive_property->set_edm_name( 'Test2' ) ##NO_TEXT.
    lo_primitive_property->set_edm_type( 'String' ) ##NO_TEXT.
